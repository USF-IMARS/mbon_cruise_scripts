...
cal <- 
  tribble(
    ...
    "2026-03-10", 0.18127,       0.37322,           27.29,            189.91,
...
} else if (nrow(meta_all) != 0) {
  message(sprintf("%s needs a process log.\n", unique(meta_all$cruise_id)))
...
save_meta <-
  ...
  save_meta <- 
    crs_log_exst %>%
    # if need to update a specific cruise
