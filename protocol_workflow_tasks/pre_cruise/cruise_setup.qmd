...
cruise_id <-
  tibble(
    ...
    start_dates = "November 9 2024",         # START DATE HERE, month day year
    end_dates   = "November 17 2024",           # END DATE HERE, month day year
...
loca <-
  ...
  filter(is.na(other) | str_detect(other, "Cross")) %T>% 
  print()
...
if (!cruise_id$cross_shelf) {
  ...
  cli_alert_info("Keeping {.emph {col_red(\"cross shelf transect station!\")}}")
}
