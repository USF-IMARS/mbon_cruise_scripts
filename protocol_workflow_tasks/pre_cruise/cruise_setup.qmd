...
cruise_folder_path <- here(cloud_dir, "years")
# cruise_folder_path <- here("data", "years")

# ---- Edit Cruise Info ----
cruise_id <-
  tibble(
    ship        = "H",                                     # HERE, ship acronym
    start_dates = "November 10 2023",         # START DATE HERE, month day year
    end_dates   = "November 17 2023",           # END DATE HERE, month day year
